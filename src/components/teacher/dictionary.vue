        ...
        <el-card>
            ...
            <div id="printMe" ref="printContent">
                <el-table :data="studentlistShow" border stripe>
                    <el-table-column :label="this.input2 + '   学期   ' + this.studentlist[0].open.course.course_name+ '   课程   学生名单'" align="center">
                        <el-table-column type="index" align="center"></el-table-column>
                        <el-table-column label="学号" prop="student.user.user_id" width="100px" align="center"></el-table-column>
                        <el-table-column label="姓名" prop="student.user.user_name" width="90px" align="center"></el-table-column>
                        <el-table-column label="课程号" prop="open.course.course_id" width="90px" align="center"></el-table-column>
                        <el-table-column label="课程名" prop="open.course.course_name" width="120px" align="center"></el-table-column>
                        <el-table-column label="学期" prop="open.semester" width="90px" align="center"></el-table-column>
