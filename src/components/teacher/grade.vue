    ...
    <div>
        ...
        <el-card>
            ...
            <el-row :gutter="20">
                ...
                <el-col :span="4">
                    <el-button @click="getstudent" type="primary">
                        搜索
                    </el-button>
                </el-col>
            ...
            <div id="printMe" ref="printContent">
                <el-table :data="studentlistShow" border stripe>
                    <el-table-column :label="this.input2 + '   学期   ' + this.studentlist[0].open.course.course_name+ '   课程   学生成绩登记表'" align="center">
                        <el-table-column type="index" align="center"></el-table-column>
                        <el-table-column label="学号" prop="student.user.user_id" width="120px" align="center"></el-table-column>
                        <el-table-column label="姓名" prop="student.user.user_name" width="100px" align="center"></el-table-column>
                        <el-table-column label="课程号" prop="open.course.course_id" width="100px" align="center"></el-table-column>
                        <el-table-column label="课程名" prop="open.course.course_name" width="150px" align="center"></el-table-column>
                        <el-table-column label="学期" prop="open.semester" width="100px" align="center"></el-table-column>
                        <el-table-column label="成绩" align="center">
                            <template slot-scope="scope">
                                <el-button type="text"
                                           icon="el-icon-circle-plus-outline"
                                           size="medium"
                                           @click="showAddDialog(scope.row.student.user.user_id)">录入</el-button>
                            </template>
                        </el-table-column>
                    </el-table-column>
                </el-table>
                ...
                <el-row>
                    <el-col :span="15">
                        <el-form-item label="成绩" prop="score">
                            <el-input v-model.number="addForm.score"
                                      placeholder="请输入学生成绩"
                                      clearable></el-input>
                        </el-form-item>
                    </el-col>
        ...
        methods: {
            ...
            addScore() {
                this.$refs.addFormRef.validate(async (valid) => {
                    if (!valid) return
                    // 校验正确则发起请求
                    const { data: res } = await this.$http.put('teacher/score/edit/?student=' + this.addForm.user_id,
                        {
