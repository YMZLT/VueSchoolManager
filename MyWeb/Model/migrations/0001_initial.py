# Generated by Django 3.1.7 on 2021-04-20 12:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('teacher', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='Model.user')),
            ],
        ),
        migrations.CreateModel(
            name='StudentTable',
            fields=[
                ...
                ('college', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Model.collegetable')),
                ('student', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='Model.user')),
            ],
        ),
        migrations.CreateModel(
            name='ScoreTable',
        ...
        migrations.AddField(
            ...
            name='teacher',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Model.teachertable'),
        ),
    ]
